...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <section>
        ...
        <p>READ THIS: We highly suggest that you do not use the email address from your school, work, Internet provider, or ARRL address. Eventually, you will (a) not go to school there, (b) not work there, (c) find a better Internet connection, or (d) not renew your ARRL membership - and then we won't have a way to reach you. If you need an alternative for email, try <a target="_blank" href="https://gmail.com">Gmail</a>.</p>
