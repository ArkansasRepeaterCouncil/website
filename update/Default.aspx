            ...
            <ajaxToolkit:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Height="400px" Width="80%" ScrollBars="Auto">
                <ajaxToolkit:TabPanel ID="tabDetails" runat="server" HeaderText="Details">
                    <ContentTemplate>
                        ...
                        <asp:Label ID="lblAMSL" CssClass="formLabel" runat="server" Text="Altitude"></asp:Label><asp:TextBox ID="txtAMSL" CssClass="textInput" runat="server"> meters</asp:TextBox><br />
                        ...
                        <asp:Label ID="lblAntennaHeight" CssClass="formLabel" runat="server" Text="Antenna height"></asp:Label><asp:TextBox ID="txtAntennaHeight" CssClass="textInput" runat="server"></asp:TextBox> meters<asp:CustomValidator ID="validAntennaHeight" runat="server" ErrorMessage="Antenna height may not be more than 15.24 meters (50 feet) over the coordinated antenna height." Text="*" OnServerValidate="validAntennaHeight_ServerValidate"></asp:CustomValidator><br />
