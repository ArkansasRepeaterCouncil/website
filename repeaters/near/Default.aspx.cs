...
public partial class repeaters_Default : System.Web.UI.Page
{
	...
	{
		if ((Page.IsPostBack) && (txtDistance.Text != string.Empty) && (txtLatitude.Text != string.Empty) && (txtLongitude.Text != string.Empty))
		{
			using (var webClient = new System.Net.WebClient())
			{
				string json = webClient.DownloadString(System.Configuration.ConfigurationManager.AppSettings["webServiceRootUrl"] + "ListRepeatersNearPoint?lat=" + txtLatitude.Text + "&lon=" + txtLongitude.Text + "&miles=" + txtDistance.Text);
